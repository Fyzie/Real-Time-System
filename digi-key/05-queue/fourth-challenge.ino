...
// Task: User interface (read input delay and write blinked at 100 times)
...
// Task: Blink accordingly and notify UI task upon blinking 100 times at same rate
void blinkLED(void *parameters) {
  ...
  while (1) {
    ...
    // Message will be sent to UI task if it blinked 100 times at the same rate
    counter++;
